...
def trained_choose_action(state):
...
print("How many rounds of training would you like the agent to do? (3-5 are recommended)")
...
for TRIAL_NUMBER in range(num_trials):
    ...
    while not done:
        ...
        #prints every 25 episodes to 
        if(EPISODE % 25 == 0):
            print("Update after episode")
            print(EPISODE)
            print(state)
...
print("Agent is now trained! Would you like to see the trained agent solve this maze now?\n Enter y if yes, otherwise enter anything else if not. ")
answer = input()
...
if answer == "y":
    ...
    while not done2:
        ...
        action = trained_choose_action(state)
